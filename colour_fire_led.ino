...
// Array of temperature readings at each simulation cell
  ...
  // Step 1.  Cool down every cell a little
    ...
    for( int k= NUM_LEDS - 1; k >= 2; k--) {
      heat[k] = (heat[k - 1] + heat[k - 2] + heat[k - 2] ) / 6;
    }
    ...
    else if(kk>1000 & kk<=1250){
      r1 = (-kk)%250;
      g1 = 0;
      b1 = (kk)%250;
      r2 = map(-kk%250,0,250,0,50);
      g2 = 250;
      b2 = map(kk%250,0,250,0,50);
    }else if(kk>1250 & kk<=2000){
      r1 = 0;
      g1 = 0;
      b1 = 250;
      r2 = 50;
    ...
    else if(kk>2000 & kk<=2250){
      r1 = 0;
      g1 = kk%250;
      b1 = -kk%250;
      r2 = map(-kk%250,0,250,0,50);
      g2 = 250;
      b2 = map(kk%250,0,250,150,250);
    }else if(kk>2250 & kk<=3000){
      r1 = 0;
      g1 = 250;
      b1 = 0;
      r2 = 0;
...
//      CRGB color = HeatColor( heat[j]);
      CRGB color = ColorFromPalette( CRGBPalette16( CRGB::Black, CRGB(r1,g1,b1), CRGB(r2,g2,b2),  CRGB(r2,g2,b2)), heat[j]);
